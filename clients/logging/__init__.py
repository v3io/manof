...
import formatter.human_readable
...
class Client(object):
    ...
    def __init__(self,
        ...
        if output_stdout:
            ...
            human_stdout_handler.setFormatter(formatter.human_readable.
    ...
    def enable_log_file_writing(self,
        ...
        if not any(isinstance(h, logging.handlers.RotatingFileHandler) for h in self.logger.handlers):
            ...
            rotating_file_handler.setFormatter(formatter.json.FilebeatJsonFormatter())
